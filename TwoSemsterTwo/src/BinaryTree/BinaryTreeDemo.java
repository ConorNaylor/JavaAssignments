...
//		BinaryTree<String> testTree = MMExtra.createRecursiveTree(3);
	...
	public static void createTreeHeightFive(BinaryTree<String> tree){
		...
		BinaryTree<String> aaTree = new BinaryTree<String>("1");
		BinaryTree<String> bbTree = new BinaryTree<String>("2");
		BinaryTree<String> ccTree = new BinaryTree<String>("3");
		BinaryTree<String> ddTree = new BinaryTree<String>("4");
		BinaryTree<String> eeTree = new BinaryTree<String>("5");
