...
public class LeagueStatstest {
	...
	public void setUp() throws Exception{
		...
		Player player1 = new Player("saurez");
		Player player2 = new Player("messi");
		Player player3 = new Player("ronaldo");
		Player player4 = new Player("gerrard");
		Player player5 = new Player("xabi");
		Player player6 = new Player("alonso");
		Player player7 = new Player("neymar");
		Player player8 = new Player("coutinho");
		Player player9 = new Player("costa");
		Player player10 = new Player("hazard");
		Player player11 = new Player("sakho");
		Player player12 = new Player("mikel");
